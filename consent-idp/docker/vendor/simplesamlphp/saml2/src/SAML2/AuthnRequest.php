...
class SAML2_AuthnRequest extends SAML2_Request
{
	...
	// We disable this branch to avoid ever adding scoping in authentication requests
        if (false && ($this->ProxyCount !== NULL || count($this->IDPList) > 0 || count($this->RequesterID) > 0)) {
